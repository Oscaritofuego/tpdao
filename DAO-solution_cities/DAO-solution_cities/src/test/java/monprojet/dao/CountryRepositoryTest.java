...
public class CountryRepositoryTest {
    ...
    @Test
    void nbrPopulation(){
        long populationParis = countryDAO.calculatePopulationByCountryId(1);
        assertEquals(populationParis, 12); 
    }

    @Test
    void checkListPopulationName(){
        List<CountryNamePopulation> countryPopulationList = countryDAO.findCountryPopulation();
        assertNotNull(countryPopulationList);
        for (CountryNamePopulation interfaceNamePop : countryPopulationList) {
            System.out.println("Country: " + interfaceNamePop.getNomPays() + ", Population: " + interfaceNamePop.getPopulation());
        }
    }
